...
const index = () => {
  return (
    ...
    <Stack sx={{position:{md:"absolute",xs:"absolute",sm:"absolute",lg:"absolute"},top:{md:"50%",xs:"50%",sm:"50%",lg:"50%"},width:{md:"100%",xs:"100%",sm:"100%",lg:"100%"},textAlign:{md:"center",xs:"center",sm:"center",lg:"center"},transform:{md:"translateY(-50%)",xs:"translateY(-50%)",sm:"translateY(-50%)",lg:"translateY(-50%)"}}}>
     <Typography variant='h1' sx={{color:{md:"#fff",xs:"#fff",sm:"#fff",lg:"#fff"},fontSize:{md:"70px",xs:"24px",sm:"30px",lg:"70px"}}}>Hussain Enterprises</Typography>
     <Typography variant='p' sx={{pt:{md:"50px",xs:"30px",sm:"30px",lg:"50px"},fontSize:{md:"50px",xs:"12px",lg:"50px",sm:"20px"},color:{md:"#fff",xs:"#fff",sm:"#fff",lg:"#fff"}}}>Commerceial Cleaning Services Human Resource Management</Typography>
    </Stack>
