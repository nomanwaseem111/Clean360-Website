...
const index = () => {
    ...
    const fadeImages = [
        {
          ...
          link2:'https://clean360.dexignlab.com/xhtml/images/client-logo/logo1.jpg',
          link3:'https://clean360.dexignlab.com/xhtml/images/client-logo/logo1.jpg',
          link4:'https://clean360.dexignlab.com/xhtml/images/client-logo/logo1.jpg'
    ...
    return (
      <Stack display={{md:'flex',xs:"flex"}} justifyContent={{md:"center",xs:'center'}} alignItems={{md:"center",xs:"center"}}>
        <Stack  sx={{width:{md:"50%",xs:"100%"},height:{md:"auto",xs:'auto'},background:{md:"#fff",xs:'#fff'}}} >
        <Slide >
